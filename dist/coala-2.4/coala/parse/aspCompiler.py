...
class AspCompiler(aspCom.AspCompiler):
	...
	def print_data(self,data):
		...
		if False:
			...
			print "ASP Stuff: ","; ".join(str(x) for x in data['preds'])
			print "Actions: ","; ".join(str(x) for x in data['actions'])
			print "Fluents: ","; ".join(str(x) for x in data['fluents'])
			print "Integers: ","; ".join(str(x) for x in data['integers'])
			print "defined_fluents: ","; ".join(str(x) for x in data['defined_fluents'])
			print "static_laws: ","; ".join(str(x) for x in data['static_laws'])
			print "dynamic_laws: ","; ".join(str(x) for x in data['dynamic_laws'])
			print "impossible_laws: ","; ".join(str(x) for x in data['impossible_laws'])
			print "default_laws: ","; ".join(str(x) for x in data['default_laws'])
			print "nonexecutable_laws: ","; ".join(str(x) for x in data['nonexecutable_laws'])
			print "inertial_laws: ","; ".join(str(x) for x in data['inertial_laws'])
			print "initially_laws: ","; ".join(str(x) for x in data['initially_laws'])
			print "goals: ","; ".join(str(x) for x in data['goals'])
			print "roles: ","; ".join(str(x) for x in data['roles'])
		
		if True:
			
			print "-------------------"
			
			print "ASP Stuff: ","; ".join(x.typestr() for x in data['preds'])
			print "Actions: ","; ".join(x.typestr() for x in data['actions'])
			print "Fluents: ","; ".join(x.typestr() for x in data['fluents'])
			print "Integers: ","; ".join(x.typestr() for x in data['integers'])
			print "defined_fluents: ","; ".join(x.typestr() for x in data['defined_fluents'])
			print "static_laws: ","; ".join(x.typestr() for x in data['static_laws'])
			print "dynamic_laws: ","; ".join(x.typestr() for x in data['dynamic_laws'])
			print "impossible_laws: ","; ".join(x.typestr() for x in data['impossible_laws'])
			print "default_laws: ","; ".join(x.typestr() for x in data['default_laws'])
			print "nonexecutable_laws: ","; ".join(x.typestr() for x in data['nonexecutable_laws'])
			print "inertial_laws: ","; ".join(x.typestr() for x in data['inertial_laws'])
			print "initially_laws: ","; ".join(x.typestr() for x in data['initially_laws'])
			print "goals: ","; ".join(x.typestr() for x in data['goals'])
			print "roles: ","; ".join(str(x) for x in data['roles']) # x.typestr()

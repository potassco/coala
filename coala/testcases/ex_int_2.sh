...
ls int*.bc | while read x; do
    ...
    res=`coala $x 2>/dev/null | clingo - ../../encodings/arithmetic_clingo.lp 1000 -c k=0 2>&1 | tail -n 4 | head -n 1 | grep -o "[0-9]*"`
    ...
    res=`coala $x 2>/dev/null | clingo - ../../encodings/arithmetic_clingo.lp 1000 2>&1 | tail -n 4 | head -n 1 | grep -o "[0-9]*"`

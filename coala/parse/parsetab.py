...
_lr_productions = [
  ...
  ('program -> program_part','program',1,'p_program','parser.py',53),
  ('program -> program program_part','program',2,'p_program','parser.py',54),
  ('program_part -> rule DOT','program_part',2,'p_program_part','parser.py',58),
  ('program_part -> ESCAPE_ASP','program_part',1,'p_program_part','parser.py',59),
  ('program_part -> ROLE_BEGIN role ROLE_END','program_part',3,'p_program_part','parser.py',60),
  ('role -> <empty>','role',0,'p_role','parser.py',89),
  ('role -> role rule DOT','role',3,'p_role','parser.py',90),
  ('role -> role ESCAPE_ASP','role',2,'p_role','parser.py',91),
  ('rule -> fact','rule',1,'p_rule','parser.py',118),
  ('rule -> law','rule',1,'p_rule','parser.py',119),
  ('rule -> query','rule',1,'p_rule','parser.py',120),
  ('fact -> pred_fact','fact',1,'p_fact','parser.py',124),
  ('fact -> act_fact','fact',1,'p_fact','parser.py',125),
  ('fact -> flu_fact','fact',1,'p_fact','parser.py',126),
  ('law -> static_law','law',1,'p_law','parser.py',130),
  ('law -> dynamic_law','law',1,'p_law','parser.py',131),
  ('law -> inertial_law','law',1,'p_law','parser.py',132),
  ('law -> default_law','law',1,'p_law','parser.py',133),
  ('law -> imposs_law','law',1,'p_law','parser.py',134),
  ('law -> nonexe_law','law',1,'p_law','parser.py',135),
  ('law -> visible_law','law',1,'p_law','parser.py',136),
  ('visible_law -> VISIBLE fluent_formula if_part where_part','visible_law',4,'p_visible_law','parser.py',140),
  ('query -> init_rule','query',1,'p_query','parser.py',146),
  ('query -> goal_query','query',1,'p_query','parser.py',147),
  ('pred_fact -> formula where_part','pred_fact',2,'p_pred_fact','parser.py',151),
  ('act_fact -> ACT fluent_formula where_part','act_fact',3,'p_act_fact','parser.py',157),
  ('flu_fact -> FLU fluent_formula where_part','flu_fact',3,'p_flu_fact','parser.py',162),
  ('flu_fact -> INT fluent_formula where_part','flu_fact',3,'p_flu_fact','parser.py',163),
  ('flu_fact -> defined_fluent fluent_formula where_part','flu_fact',3,'p_flu_fact','parser.py',164),
  ('defined_fluent -> DFLU','defined_fluent',1,'p_defined_fluent','parser.py',263),
  ('defined_fluent -> DEF FLU','defined_fluent',2,'p_defined_fluent','parser.py',264),
  ('static_law -> formula IF formula ifcons_part where_part','static_law',5,'p_static_law','parser.py',268),
  ('static_law -> formula IFCONS formula where_part','static_law',4,'p_static_law','parser.py',269),
  ('dynamic_law -> formula after_part ifcons_part where_part','dynamic_law',4,'p_dynamic_law','parser.py',281),
  ('dynamic_law -> formula CAUSES formula where_part','dynamic_law',4,'p_dynamic_law','parser.py',282),
  ('dynamic_law -> formula CAUSES formula IF formula where_part','dynamic_law',6,'p_dynamic_law','parser.py',283),
  ('inertial_law -> INERTIAL fluent_formula where_part','inertial_law',3,'p_inertial_law','parser.py',299),
  ('default_law -> DEFAULT formula where_part','default_law',3,'p_default_law','parser.py',304),
  ('default_law -> DEFAULT formula IF formula where_part','default_law',5,'p_default_law','parser.py',305),
  ('default_law -> DEFAULT formula AFTER formula where_part','default_law',5,'p_default_law','parser.py',306),
  ('imposs_law -> IMPOSSIBLE formula ifcons_part where_part','imposs_law',4,'p_imposs_law','parser.py',320),
  ('nonexe_law -> NONEXE formula if_part ifcons_part where_part','nonexe_law',5,'p_nonexe_law','parser.py',334),
  ('init_rule -> INIT formula where_part','init_rule',3,'p_init_rule','parser.py',350),
  ('goal_query -> GOAL formula where_part','goal_query',3,'p_goal_query','parser.py',356),
  ('if_part -> <empty>','if_part',0,'p_if_part','parser.py',364),
  ('if_part -> IF formula','if_part',2,'p_if_part','parser.py',365),
  ('after_part -> AFTER formula','after_part',2,'p_after_part','parser.py',373),
  ('ifcons_part -> <empty>','ifcons_part',0,'p_ifcons_part','parser.py',378),
  ('ifcons_part -> IFCONS formula','ifcons_part',2,'p_ifcons_part','parser.py',379),
  ('where_part -> <empty>','where_part',0,'p_where_part','parser.py',386),
  ('where_part -> WHERE bindings','where_part',2,'p_where_part','parser.py',387),
  ('bindings -> binding','bindings',1,'p_bindings','parser.py',392),
  ('bindings -> bindings COMMA binding','bindings',3,'p_bindings','parser.py',393),
  ('binding -> ACT term','binding',2,'p_binding','parser.py',401),
  ('binding -> FLU term_equalpart','binding',2,'p_binding','parser.py',402),
  ('binding -> term_boolean','binding',1,'p_binding','parser.py',403),
  ('term_equalpart -> term','term_equalpart',1,'p_term_equalpart','parser.py',417),
  ('term_equalpart -> term EQ term_numeric','term_equalpart',3,'p_term_equalpart','parser.py',418),
  ('term_equalpart -> term EQ LBRAC term_number_list RBRAC','term_equalpart',5,'p_term_equalpart','parser.py',419),
  ('term_equalpart -> term EQ term_numeric DDOT term_numeric','term_equalpart',5,'p_term_equalpart','parser.py',420),
  ('binding_or_range -> term','binding_or_range',1,'p_binding_or_range','parser.py',442),
  ('binding_or_range -> term_numeric DDOT term_numeric','binding_or_range',3,'p_binding_or_range','parser.py',443),
  ('formula -> term_boolean','formula',1,'p_formula','parser.py',450),
  ('formula -> term_boolean COMMA formula','formula',3,'p_formula','parser.py',451),
  ('formula -> term_boolean COLON binding_or_range','formula',3,'p_formula','parser.py',452),
  ('formula -> term_boolean COLON binding_or_range COMMA formula','formula',5,'p_formula','parser.py',453),
  ('fluent_formula -> term_equalpart','fluent_formula',1,'p_fluent_formula','parser.py',486),
  ('fluent_formula -> term_equalpart COMMA fluent_formula','fluent_formula',3,'p_fluent_formula','parser.py',487),
  ('fluent_formula -> term_equalpart COLON binding_or_range','fluent_formula',3,'p_fluent_formula','parser.py',488),
  ('fluent_formula -> term_equalpart COLON binding_or_range COMMA fluent_formula','fluent_formula',5,'p_fluent_formula','parser.py',489),
  ('term_number_list -> term_numeric','term_number_list',1,'p_term_number_list','parser.py',505),
  ('term_number_list -> term_numeric COMMA term_number_list','term_number_list',3,'p_term_number_list','parser.py',506),
  ('term_boolean -> term','term_boolean',1,'p_term_boolean','parser.py',514),
  ('term_boolean -> NOT term','term_boolean',2,'p_term_boolean','parser.py',515),
  ('term_boolean -> MINUS term','term_boolean',2,'p_term_boolean','parser.py',516),
  ('term_boolean -> asp_term','term_boolean',1,'p_term_boolean','parser.py',517),
  ('term_numeric -> term','term_numeric',1,'p_term_numeric','parser.py',526),
  ('term_numeric -> MINUS term','term_numeric',2,'p_term_numeric','parser.py',527),
  ('term_numeric -> number','term_numeric',1,'p_term_numeric','parser.py',528),
  ('term -> variable','term',1,'p_term','parser.py',535),
  ('term -> identifier','term',1,'p_term','parser.py',536),
  ('term -> IDENTIFIER LBRAC term_number_list RBRAC','term',4,'p_term','parser.py',537),
  ('term -> IDENTIFIER LBRAC term_number_list RBRAC APOS','term',5,'p_term','parser.py',538),
  ('variable -> VARIABLE','variable',1,'p_variable','parser.py',547),
  ('number -> NUMBER','number',1,'p_number','parser.py',551),
  ('number -> MINUS NUMBER','number',2,'p_number','parser.py',552),
  ('identifier -> IDENTIFIER','identifier',1,'p_identifier','parser.py',558),
  ('identifier -> IDENTIFIER APOS','identifier',2,'p_identifier','parser.py',559),
  ('identifier -> TRUE','identifier',1,'p_identifier','parser.py',560),
  ('identifier -> FALSE','identifier',1,'p_identifier','parser.py',561),
  ('asp_term -> asp_operation asp_eqoperator asp_operation','asp_term',3,'p_asp_term','parser.py',578),
  ('asp_eqoperator -> EQQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',589),
  ('asp_eqoperator -> EQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',590),
  ('asp_eqoperator -> NEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',591),
  ('asp_eqoperator -> LT','asp_eqoperator',1,'p_asp_eqoperator','parser.py',592),
  ('asp_eqoperator -> GT','asp_eqoperator',1,'p_asp_eqoperator','parser.py',593),
  ('asp_eqoperator -> LE','asp_eqoperator',1,'p_asp_eqoperator','parser.py',594),
  ('asp_eqoperator -> GE','asp_eqoperator',1,'p_asp_eqoperator','parser.py',595),
  ('asp_eqoperator -> ASSIGN','asp_eqoperator',1,'p_asp_eqoperator','parser.py',596),
  ('asp_eqoperator -> PLUSEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',597),
  ('asp_eqoperator -> MINUSEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',598),
  ('asp_operation -> asp_mult_operation','asp_operation',1,'p_asp_operation','parser.py',602),
  ('asp_operation -> asp_operation PLUS asp_mult_operation','asp_operation',3,'p_asp_operation','parser.py',603),
  ('asp_operation -> asp_operation MINUS asp_mult_operation','asp_operation',3,'p_asp_operation','parser.py',604),
  ('asp_operation -> term_numeric DDOT term_numeric','asp_operation',3,'p_asp_operation','parser.py',605),
  ('asp_mult_operation -> asp_pow_operation','asp_mult_operation',1,'p_asp_mult_operation','parser.py',612),
  ('asp_mult_operation -> asp_mult_operation TIMES asp_pow_operation','asp_mult_operation',3,'p_asp_mult_operation','parser.py',613),
  ('asp_mult_operation -> asp_mult_operation DIV asp_pow_operation','asp_mult_operation',3,'p_asp_mult_operation','parser.py',614),
  ('asp_pow_operation -> asp_brac_operation','asp_pow_operation',1,'p_asp_pow_operation','parser.py',621),
  ('asp_pow_operation -> asp_pow_operation POWER asp_brac_operation','asp_pow_operation',3,'p_asp_pow_operation','parser.py',622),
  ('asp_brac_operation -> term_numeric','asp_brac_operation',1,'p_asp_brac_operation','parser.py',629),
  ('asp_brac_operation -> LBRAC asp_operation RBRAC','asp_brac_operation',3,'p_asp_brac_operation','parser.py',630),
]

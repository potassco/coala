...
_lr_productions = [
  ...
  ('defined_fluent -> DFLU','defined_fluent',1,'p_defined_fluent','parser.py',262),
  ('defined_fluent -> DEF FLU','defined_fluent',2,'p_defined_fluent','parser.py',263),
  ('static_law -> formula IF formula ifcons_part where_part','static_law',5,'p_static_law','parser.py',267),
  ('static_law -> formula IFCONS formula where_part','static_law',4,'p_static_law','parser.py',268),
  ('dynamic_law -> formula after_part ifcons_part where_part','dynamic_law',4,'p_dynamic_law','parser.py',280),
  ('dynamic_law -> formula CAUSES formula where_part','dynamic_law',4,'p_dynamic_law','parser.py',281),
  ('dynamic_law -> formula CAUSES formula IF formula where_part','dynamic_law',6,'p_dynamic_law','parser.py',282),
  ('inertial_law -> INERTIAL fluent_formula where_part','inertial_law',3,'p_inertial_law','parser.py',298),
  ('default_law -> DEFAULT formula where_part','default_law',3,'p_default_law','parser.py',303),
  ('default_law -> DEFAULT formula IF formula where_part','default_law',5,'p_default_law','parser.py',304),
  ('default_law -> DEFAULT formula AFTER formula where_part','default_law',5,'p_default_law','parser.py',305),
  ('imposs_law -> IMPOSSIBLE formula ifcons_part where_part','imposs_law',4,'p_imposs_law','parser.py',319),
  ('nonexe_law -> NONEXE formula if_part ifcons_part where_part','nonexe_law',5,'p_nonexe_law','parser.py',333),
  ('init_rule -> INIT formula where_part','init_rule',3,'p_init_rule','parser.py',349),
  ('goal_query -> GOAL formula where_part','goal_query',3,'p_goal_query','parser.py',355),
  ('if_part -> <empty>','if_part',0,'p_if_part','parser.py',363),
  ('if_part -> IF formula','if_part',2,'p_if_part','parser.py',364),
  ('after_part -> AFTER formula','after_part',2,'p_after_part','parser.py',372),
  ('ifcons_part -> <empty>','ifcons_part',0,'p_ifcons_part','parser.py',377),
  ('ifcons_part -> IFCONS formula','ifcons_part',2,'p_ifcons_part','parser.py',378),
  ('where_part -> <empty>','where_part',0,'p_where_part','parser.py',385),
  ('where_part -> WHERE bindings','where_part',2,'p_where_part','parser.py',386),
  ('bindings -> binding','bindings',1,'p_bindings','parser.py',391),
  ('bindings -> bindings COMMA binding','bindings',3,'p_bindings','parser.py',392),
  ('binding -> ACT term','binding',2,'p_binding','parser.py',400),
  ('binding -> FLU term_equalpart','binding',2,'p_binding','parser.py',401),
  ('binding -> term_boolean','binding',1,'p_binding','parser.py',402),
  ('term_equalpart -> term','term_equalpart',1,'p_term_equalpart','parser.py',416),
  ('term_equalpart -> term EQ term_numeric','term_equalpart',3,'p_term_equalpart','parser.py',417),
  ('term_equalpart -> term EQ LBRAC term_number_list RBRAC','term_equalpart',5,'p_term_equalpart','parser.py',418),
  ('term_equalpart -> term EQ term_numeric DDOT term_numeric','term_equalpart',5,'p_term_equalpart','parser.py',419),
  ('binding_or_range -> term','binding_or_range',1,'p_binding_or_range','parser.py',441),
  ('binding_or_range -> term_numeric DDOT term_numeric','binding_or_range',3,'p_binding_or_range','parser.py',442),
  ('formula -> term_boolean','formula',1,'p_formula','parser.py',449),
  ('formula -> term_boolean COMMA formula','formula',3,'p_formula','parser.py',450),
  ('formula -> term_boolean COLON binding_or_range','formula',3,'p_formula','parser.py',451),
  ('formula -> term_boolean COLON binding_or_range COMMA formula','formula',5,'p_formula','parser.py',452),
  ('fluent_formula -> term_equalpart','fluent_formula',1,'p_fluent_formula','parser.py',485),
  ('fluent_formula -> term_equalpart COMMA fluent_formula','fluent_formula',3,'p_fluent_formula','parser.py',486),
  ('fluent_formula -> term_equalpart COLON binding_or_range','fluent_formula',3,'p_fluent_formula','parser.py',487),
  ('fluent_formula -> term_equalpart COLON binding_or_range COMMA fluent_formula','fluent_formula',5,'p_fluent_formula','parser.py',488),
  ('term_number_list -> term_numeric','term_number_list',1,'p_term_number_list','parser.py',504),
  ('term_number_list -> term_numeric COMMA term_number_list','term_number_list',3,'p_term_number_list','parser.py',505),
  ('term_boolean -> term','term_boolean',1,'p_term_boolean','parser.py',513),
  ('term_boolean -> NOT term','term_boolean',2,'p_term_boolean','parser.py',514),
  ('term_boolean -> MINUS term','term_boolean',2,'p_term_boolean','parser.py',515),
  ('term_boolean -> asp_term','term_boolean',1,'p_term_boolean','parser.py',516),
  ...
  ('asp_term -> asp_operation asp_eqoperator asp_operation','asp_term',3,'p_asp_term','parser.py',577),
  ('asp_eqoperator -> EQQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',588),
  ('asp_eqoperator -> EQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',589),
  ('asp_eqoperator -> NEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',590),
  ('asp_eqoperator -> LT','asp_eqoperator',1,'p_asp_eqoperator','parser.py',591),
  ('asp_eqoperator -> GT','asp_eqoperator',1,'p_asp_eqoperator','parser.py',592),
  ('asp_eqoperator -> LE','asp_eqoperator',1,'p_asp_eqoperator','parser.py',593),
  ('asp_eqoperator -> GE','asp_eqoperator',1,'p_asp_eqoperator','parser.py',594),
  ('asp_eqoperator -> ASSIGN','asp_eqoperator',1,'p_asp_eqoperator','parser.py',595),
  ('asp_eqoperator -> PLUSEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',596),
  ('asp_eqoperator -> MINUSEQ','asp_eqoperator',1,'p_asp_eqoperator','parser.py',597),
  ('asp_operation -> asp_mult_operation','asp_operation',1,'p_asp_operation','parser.py',601),
  ('asp_operation -> asp_operation PLUS asp_mult_operation','asp_operation',3,'p_asp_operation','parser.py',602),
  ('asp_operation -> asp_operation MINUS asp_mult_operation','asp_operation',3,'p_asp_operation','parser.py',603),
  ('asp_operation -> term_numeric DDOT term_numeric','asp_operation',3,'p_asp_operation','parser.py',604),
  ('asp_mult_operation -> asp_pow_operation','asp_mult_operation',1,'p_asp_mult_operation','parser.py',611),
  ('asp_mult_operation -> asp_mult_operation TIMES asp_pow_operation','asp_mult_operation',3,'p_asp_mult_operation','parser.py',612),
  ('asp_mult_operation -> asp_mult_operation DIV asp_pow_operation','asp_mult_operation',3,'p_asp_mult_operation','parser.py',613),
  ('asp_pow_operation -> asp_brac_operation','asp_pow_operation',1,'p_asp_pow_operation','parser.py',620),
  ('asp_pow_operation -> asp_pow_operation POWER asp_brac_operation','asp_pow_operation',3,'p_asp_pow_operation','parser.py',621),
  ('asp_brac_operation -> term_numeric','asp_brac_operation',1,'p_asp_brac_operation','parser.py',628),
  ('asp_brac_operation -> LBRAC asp_operation RBRAC','asp_brac_operation',3,'p_asp_brac_operation','parser.py',629),
]
